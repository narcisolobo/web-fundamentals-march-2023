...
// If we wanted to console.log the names of the pokémon who have
// an id greater than 99 we could...
...
/*
  Challenges - using the array of pokémon above and loops:
    ...
    1.  console.log the pokémon objects whose id is evenly
        divisible by 3
    2.  console.log the pokémon objects that have more than
        one type
    3.  console.log the names of the pokémon whose only type
        is "poison"
    4.  console.log the first type of all the pokémon whose
